...
const features = [
  ...
  },
  {
    ...
    desc: "Flight tickets, hotel confirmations, booking PDFs upload them once and they live inside the trip. Everyone has access, always.",
    tag: "Images · Tickets",
    tagColor: "bg-[#B8F0D4]",
  },
  {
  ...
  },
  {
    ...
    iconBg: "bg-[#FFB8B8]",
    title: "Checklists",
    desc: "Packing lists, to-dos, group tasks assign items to members and check them off as you go. No separate notes app needed.",
    tag: "Assign to members",
    tagColor: "bg-[#FFB8B8]",
  },
  {
