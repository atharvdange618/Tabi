...
export function HomeNav() {
  return (
    <nav className="bg-white border-b-2 border-brutal-border px-6 h-16 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          href="/sign-up"
          className="brutal-btn bg-brand-blue px-5 py-2 rounded-lg text-sm no-underline text-foreground"
        >
          Start Planning
        </Link>
      </div>
